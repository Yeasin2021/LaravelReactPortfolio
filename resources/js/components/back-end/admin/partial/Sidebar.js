...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="logo d-flex justify-content-between">
        <a className="large_logo" href="index-2.html"><img src="back-end/img/logo.png" alt="" /></a>
        <a className="small_logo" href="index-2.html"><img src="back-end/img/mini_logo.png" alt="" /></a>
    ...
    <ul id="sidebar_menu">
        <li>
            <a href="index-2.html" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/dashboard.svg" alt="" />
                </div>
        ...
        <li>
            <a href="index_2.html" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/2.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Default </span>
                </div>
        ...
        <li>
            <a href="index_3.html" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/3.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Dark </span>
                </div>
        ...
        <h4 className="menu-text"><span>CUSTOM</span> <i className="fas fa-ellipsis-h"></i></h4>
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/5.svg" alt="" />
                </div>
                <div className="nav_title">
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/16.svg" alt="" />
                </div>
                <div className="nav_title">
            ...
            <ul>
                ...
                <li><a href="##">Student Index</a></li>
                <li><a href="#">Routine Maker</a></li>
                <li><a href="#">Routine Table</a></li>
        ...
        <h4 className="menu-text"><span>LAYOUT</span> <i className="fas fa-ellipsis-h"></i></h4>
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/4.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Themes</span>
                </div>
        ...
        <h4 className="menu-text"><span>Elements</span> <i className="fas fa-ellipsis-h"></i></h4>
        <li className="x">
            <a href="invoice.html" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/6.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Invoice</span>
                </div>
        ...
        <li className="x">
            <a href="calender.html" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/7.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Calander</span>
                </div>
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/8.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Products</span>
                </div>
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/9.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Icons</span>
                </div>
        ...
        <h4 className="menu-text"><span>Features</span> <i className="fas fa-ellipsis-h"></i></h4>
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/8.svg" alt="" />
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/11.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Table</span>
                </div>
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/12.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Cards</span>
                </div>
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/14.svg" alt="" />
                </div>
                <div className="nav_title">
                    <span>Widgets</span>
                </div>
        ...
        <li className="x">
            <a className="has-arrow" href="#" aria-expanded="false">
                <div className="nav_icon_small">
                    <img src="back-end/img/menu-icon/15.svg" alt="" />
                </div>
                <div className="nav_title">
